...
class PullRequestReview(github.GithubObject.CompletableGithubObject):
    """
    This class represents PullRequestReview. The reference can be found here http://developer.github.com/v3/pulls/reviews/
    """
    ...
    def delete(self):
        """
        :calls: `DELETE /repos/:owner/:repo/pulls/:number/reviews/:id <http://developer.github.com/v3/pulls/reviews>`_
        :rtype: None
        """
